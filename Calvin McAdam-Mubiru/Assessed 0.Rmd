...
The following document contains code and data retrieved from an article to do with analysing data on the weather. The specific example is on the US and Portland.
...
We also have to find and import the data we will be working with in the example:
